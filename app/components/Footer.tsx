  ...
  return (
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul>
            ...
            <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-300">FAQs & Help</a></li>
          </ul>
        </div>
      ...
      <div className="border-t border-gray-800 mt-12 pt-6 text-center text-gray-500 text-sm">
        ...
        <div className="mt-4">
          <a href="#" className="text-gray-400 hover:text-white mx-2 transition-colors duration-300">Home</a>
          <a href="#" className="text-gray-400 hover:text-white mx-2 transition-colors duration-300">Cookies</a>
          <a href="#" className="text-gray-400 hover:text-white mx-2 transition-colors duration-300">Help</a>
          <a href="#" className="text-gray-400 hover:text-white mx-2 transition-colors duration-300">FAQs</a>
        </div>
      </div>
    </footer>
  );
